                        ...
                        <div className="flex items-center justify-center pt-2" onClick={(e) => e.stopPropagation()}>
                            <div className="w-[280px] rounded-2xl overflow-hidden font-sans glass-effect">
                                ...
                                <div className="px-4 pb-3">
                                    <Link href={userLink(user?.short_id)} className="block w-full text-center py-2 rounded-lg bg-brand/10 hover:bg-brand/20 text-text-brand text-sm font-medium transition-colors">
                                        Перейти в профиль
                                    </Link>
                                </div>
