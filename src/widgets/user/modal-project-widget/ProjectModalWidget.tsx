    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col justify-between h-full">
                <div className="mt-2 pl-1 flex flex-col pb-6 h-full">

                    <div className="h-full" onClick={(e) => e.stopPropagation()}>
                        {(project?.gallery && project?.gallery?.length > 0) ?
                            <Gallery gallery={project?.gallery} className="!h-full !max-h-[400px]" />
                            :
                            <div className="max-h-[400px] h-full w-full" style={{
                    ...
                    <div className="flex justify-between items-center mt-4">
                        ...
                        <div className="flex gap-1.5">
                            {project?.repo_link && (
                                <a href={normalizeUrl(project?.repo_link)} target="_blank" rel="noreferrer" className="p-1.5 rounded-lg text-text-muted hover:text-text-main hover:bg-white/10 transition-colors" title="Репозиторий">
                            ...
                            {project?.link && (
                                <a href={normalizeUrl(project?.link)} target="_blank" rel="noreferrer" className="p-1.5 rounded-lg text-text-muted hover:text-text-main hover:bg-white/10 transition-colors" title="Сайт">
                ...
                <div>
                    ...
                    {project?.start_date && (
                        <div className="flex items-center gap-2 mt-7 mb- text-xs font-medium tracking-wide uppercase">
