...
export default function User({user, isMyProfile, isPrivate, showModals}: Props) {
        ...
        <div className="flex gap-5 items-center flex-col lg:flex-row">
            ...
            <div className="relative flex flex-col gap-2 items-center lg:items-start">
                <div className="flex gap-1 items-center">
                    ...
                    <h5
                        className={`
                            ${HasUserSubscription({user}) ? "bg-[image:var(--subscription-color)] bg-clip-text text-transparent" : "text-text-main"}  font-bold text-xl
                        `}
