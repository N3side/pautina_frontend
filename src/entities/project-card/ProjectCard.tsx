...
export default function ProjectCard({ project, isMyProfile }: ProjectCardProps) {
    ...
    return (
        <>
            ...
            <div
                className="glass-effect rounded-[18px] py-3 px-5 flex flex-col h-full cursor-pointer hover:border-brand/40 hover:shadow-[0_8px_30px_rgba(14,165,233,0.1)] hover:bg-white/[0.02] transition-all duration-300 group relative"
                onClick={open} // Теперь при клике открывается модалка
            >
                ...
                <div className="mt-2 pl-1 flex flex-col">
                    <div className="flex justify-between items-center">
                        <h4 className="text-text-main font-bold text-[22px] group-hover:text-brand transition-colors">
