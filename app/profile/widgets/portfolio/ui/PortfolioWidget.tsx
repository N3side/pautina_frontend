    ...
    return (
        <>
            <section className="mt-[clamp(30px,1.250vw_+_26.000px,50px)]">
                <header className={`flex justify-between items-center ${_window?.innerWidth <= 555 ? "flex-col items-start gap-3" : ""}`}>
                    <div className={`flex flex-col ${_window?.innerWidth <= 555 ? "" : "gap-[5px]"}`}>
                    ...
                    <Button className={`flex gap-[10px] items-center h-[fit-content] ${_window.innerWidth <= 555 ? "w-full" : ""}`} style={{
                ...
                <main>
                    ...
                    ${_window?.innerWidth >= 1024 ? "grid-cols-[repeat(auto-fit,minmax(280px,1fr))]" : "grid-cols-[repeat(auto-fit,minmax(230px,1fr))]"} grid gap-y-[clamp(15px,1.250vw_+_11.000px,35px)] 
