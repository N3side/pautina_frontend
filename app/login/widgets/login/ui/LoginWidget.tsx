                ...
                style={ _window?.innerWidth >= 1024 ? {
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-[25px] mt-[clamp(20px,1.250vw_+_16.000px,40px)] w-full ">
                        <div className="flex flex-col gap-[8px]">
                            ...
                            <input name="email" defaultValue="" id="" placeholder="ivanov@gmail.com" className="w-full px-5 py-[15px] rounded-[6px]" style={{ border: `1px solid ${COLORS.gray[2]}`, boxShadow: `0px 3px 12px ${COLORS.gray[1]}` }}/>
                            {errors?.email}
                        </div>
                        <div className="flex flex-col gap-[8px]">
                            <PautinaText variant="secondary" style={{ fontWeight: 700 }}>
                            ...
                            <input name="password" defaultValue="" type="password" id="" placeholder="******" className="w-full px-5 py-[15px] rounded-[6px]" style={{ border: `1px solid ${COLORS.gray[2]}`, boxShadow: `0px 3px 12px ${COLORS.gray[1]}` }} />
                            {errors?.password}
                        </div>

                        <div className="flex justify-between">
                            <div className="flex justify-between items-center gap-[10px] select-none" style={{fontWeight: 400}} onClick={() => setIsActive(!isActive)}>
                                <input type="checkbox" checked={isActive} name="" id="" className="w-[15px] h-[15px]" />
                                Запомнить меня
                            </div>
                            <Link href="/">
